...
COMPILER_JAR_PATH = VISH_EDITOR_PATH + "/extras/compile"
...
namespace :vish_editor do
  ...
  task :prepare do
    ...
    #Copy HTML
    system "sed -n  '/<!-- Copy HTML from here -->/,/<!-- Copy HTML until here -->/p' " + VISH_EDITOR_PATH + "/viewer.html > " + VISH_EDITOR_PLUGIN_PATH + "/app/views/free_learn/vish_editor/course/_vish_viewer.full.erb"
    system "sed -n  '/<!-- Copy HTML from here -->/,/<!-- Copy HTML until here -->/p' " + VISH_EDITOR_PATH + "/edit.html > " + VISH_EDITOR_PLUGIN_PATH + "/app/views/free_learn/vish_editor/course/_vish_editor.full.erb"
  ...
  task :compile do
    ...
    CSS_VIEWER.collect! {|x| VISH_EDITOR_PLUGIN_PATH + "/app/assets/css_to_compile/all/" + x }
    system "cat " + CSS_VIEWER.join(' ') + " > vishViewer.css"
    puts "vishViewer.css created"

    puts "Creating vishEditor.css"
    CSS_EDITOR.concat(Dir[ File.join(VISH_EDITOR_PLUGIN_PATH + "/app/assets/css_to_compile/all/", "*.css") ].sort)
    CSS_EDITOR.uniq!
    ...
    system "rm " + VISH_EDITOR_PLUGIN_PATH + "/app/assets/css_to_compile/all/*.css"
    system "mv vishViewer.css "+ VISH_EDITOR_PLUGIN_PATH + "/app/assets/css_to_compile/all/vishViewer.css"
    system "mv vishEditor.css "+ VISH_EDITOR_PLUGIN_PATH + "/app/assets/css_to_compile/all/vishEditor.css"
  ...
  def compile_js(files)
    ...
    JS_VIEWER.collect! {|x| VISH_EDITOR_PLUGIN_PATH + "/app/assets/js_to_compile/" + x }
  ...
  task :download_YUIcompressor do
    ...
    task :testing_stuff do
        puts "Testing line to prove vish_editor works"
    end
end
